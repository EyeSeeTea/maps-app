...
import { guideLength, textPadding } from './ZebraCustomBubbles';

/**
 * ZebraCustomBubble is an exact copy of the Bubble component
 * defined in `Bubble.js`.
 */
const ZebraCustomBubble = ({
    radius,
    maxRadius,
    text,
    textAlign,
...
export default ZebraCustomBubble;
