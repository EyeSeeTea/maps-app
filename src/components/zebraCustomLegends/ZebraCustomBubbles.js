...
import ZebraCustomBubble from './ZebraCustomBubble';
...
/**
 * ZebraCustomBubbles is an exact copy of the Bubbles component
 * defined in `Bubbles.js`.
 */
const ZebraCustomBubbles = ({ radiusLow, radiusHigh, color, classes }) => {
...
export default ZebraCustomBubbles;
